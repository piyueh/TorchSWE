...
cdef class ConstExtrapBC:
    ...
    def __init__(
        ...
        if ornt == 0:  # west
            _const_extrap_bc_set_west(self, Q, Bx, Qmx, Qpx, Hmx, Hpx, ngh, comp)
        elif ornt == 1:  # east
            _const_extrap_bc_set_east(self, Q, Bx, Qmx, Qpx, Hmx, Hpx, ngh, comp)
        elif ornt == 2:  # south
            _const_extrap_bc_set_south(self, Q, By, Qmy, Qpy, Hmy, Hpy, ngh, comp)
        elif ornt == 3:  # north
            _const_extrap_bc_set_north(self, Q, By, Qmy, Qpy, Hmy, Hpy, ngh, comp)
        else:
...
cdef class ConstExtrapWH(ConstExtrapBC):
    ...
    def __call__(self):
        _const_extrap_bc_w_h_kernel(
            self.qc0, self.bbc, self.bother, self.tol,
...
cdef void _const_extrap_bc_set_west(
    ConstExtrapBC bc, object Q, object Bx, object Qmx, object Qpx, object Hmx, object Hpx,
...
cdef void _const_extrap_bc_set_south(
    ConstExtrapBC bc, object Q, object By, object Qmy, object Qpy, object Hmy, object Hpy,
    const Py_ssize_t ngh, const Py_ssize_t comp
) except *:
