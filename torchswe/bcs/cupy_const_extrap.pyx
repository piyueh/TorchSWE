...
cdef _copy = cupy.ElementwiseKernel(
    "T qr",
    "T ql1, T ql2",
    """
        ql1 = qr;
...
cdef _copy_w_h = cupy.ElementwiseKernel(
    "T qr, T hr",
    "T ql1, T ql2, T hl",
    """
        ql1 = qr;
...
cpdef void _const_extrap_west_hu(q, h, const Py_ssize_t ngh) except *:
    ...
    _copy(q[1, ngh:qyed, ngh], q[1, ngh:qyed, 0],  q[1, ngh:qyed, 1])
...
cpdef void _const_extrap_west_hv(q, h, const Py_ssize_t ngh) except *:
    ...
    _copy(q[2, ngh:qyed, ngh], q[2, ngh:qyed, 0],  q[2, ngh:qyed, 1])
...
cpdef void _const_extrap_east_hu(q, h, const Py_ssize_t ngh) except *:
    ...
    _copy(q[1, ngh:qyed, qxed-1], q[1, ngh:qyed, qxed],  q[1, ngh:qyed, qxed+1])
...
cpdef void _const_extrap_east_hv(q, h, const Py_ssize_t ngh) except *:
    ...
    _copy(q[2, ngh:qyed, qxed-1], q[2, ngh:qyed, qxed],  q[2, ngh:qyed, qxed+1])
...
cpdef void _const_extrap_south_hu(q, h, const Py_ssize_t ngh) except *:
    ...
    _copy(q[1, ngh, ngh:qxed], q[1, 0, ngh:qxed], q[1, 1, ngh:qxed])
...
cpdef void _const_extrap_south_hv(q, h, const Py_ssize_t ngh) except *:
    ...
    _copy(q[2, ngh, ngh:qxed], q[2, 0, ngh:qxed], q[2, 1, ngh:qxed])
...
cpdef void _const_extrap_north_hu(q, h, const Py_ssize_t ngh) except *:
    ...
    _copy(q[1, qyed-1, ngh:qxed], q[1, qyed, ngh:qxed], q[1, qyed+1, ngh:qxed])
...
cpdef void _const_extrap_north_hv(q, h, const Py_ssize_t ngh) except *:
    ...
    _copy(q[2, qyed-1, ngh:qxed], q[2, qyed, ngh:qxed], q[2, qyed+1, ngh:qxed])
