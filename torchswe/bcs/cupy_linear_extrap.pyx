...
cdef class LinearExtrapCommon:
    ...
    # conservatives
    cdef object qc0  # w, hu, or hv at the cell centers of the 1st internal cell layer
    cdef object qc1  # w, hu, or hv at the cell centers of the 2nd internal cell layer
    cdef object qbci  # w, hu, or hv at the inner side of the boundary cell faces
    cdef object qbco  # w, hu, or hv at the outer side of the boundary cell faces
    cdef object qother  #, hu, or hv w at the inner side of the another face of the 1st internal cell
...
cdef void _linear_extrap_bc_set_west(
    ...
    if LinearExtrapBC is LinearExtrapWH:
        ...
        bc.bother = Bx[:, 1]
        bc.tol = tol
    elif LinearExtrapBC is LinearExtrapOther:
        bc.ubci = xpU[comp, :, 0]
        bc.ubco = xmU[comp, :, 0]
