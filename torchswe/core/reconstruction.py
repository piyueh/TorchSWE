...
def correct_negative_depth(states: States, topo: Topography) -> States:
    ...
    if nplike.__name__ == "legate.numpy":
        return correct_negative_depth_legate(states, topo)
    else:
        return correct_negative_depth_regular(states, topo)



def correct_negative_depth_regular(states: States, topo: Topography) -> States:
    """Fix negative depth on the both sides of cell faces.
    ...
    # legate.numpy's support of advanced indexing is buggy, so it has its own version of this func
    if nplike.__name__ == "legate.numpy":
        return correct_negative_depth_legate(states, topo)
...
def correct_negative_depth_legate(states: States, topo: Topography) -> States:
    """Legate's version of fixing negative depth on the both sides of cell faces.
